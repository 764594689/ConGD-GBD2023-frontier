# ==============================================================================
# Table S7: Sex-Stratified ASMR (GBD 2023)
# ==============================================================================
library(tidyverse)
library(flextable)
library(officer)

cat("--- Table S7: Sex-Stratified Analysis (GBD 2023) ---\n")
...
save_word_path <- file.path(output_dir, "Table_S7_Sex.docx")
...
ft <- df_wide %>% flextable() %>%
  ...
  set_caption(sprintf("Table S7. Sex-stratified ASMR for ConGDs (%d).", latest_year)) %>%
